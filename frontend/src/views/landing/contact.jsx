...
import 'animate.css';
import Outer_Header from '../../components/outer_header';
                ...
                >
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2 border border-[#8E57B2] rounded-md focus:outline-none focus:ring-2 focus:ring-[#F69332] animate__animated animate__slideInRight text-black bg-white"
